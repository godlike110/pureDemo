...
public class OrderService {
	...
	private static String[] titlesStrings = { "订单号", "机票价格", "联系人", "联系人手机号", "订单状态", "客户ip", "订单创建时间", "出发城市", "出发时间",
			"到达城市", "订单来源", "乘机人", "身份证号码" };
	...
	public Map<String, String> getOrderInfos(String site, String orderNo) throws HttpException, IOException {
		...
		List<String> orders = shellService
				.execuShell("sh " + AptConstants.SHELL_PATH + "getOrderInfo.sh " + orderNo + " " + site);
