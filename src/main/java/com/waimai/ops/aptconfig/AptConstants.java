...
//	    System.out.println("map：{}"+JSONObject.toJSONString(setMap));
        ...
        if(org.apache.commons.lang.StringUtils.isNotBlank(onlyMeituanShow) || org.apache.commons.lang.StringUtils.isNotBlank(timeLimit) || org.apache.commons.lang.StringUtils.isNotBlank(categoryName)) {
        	title.append("（限").append(StringUtils.isBlank(categoryName)?"":StringUtils.isBlank(timeLimit)&&StringUtils.isBlank(onlyMeituanShow)?categoryName:categoryName+"、").append(StringUtils.isBlank(timeLimit)?"":StringUtils.isBlank(onlyMeituanShow)?timeLimit:timeLimit+"、").append(StringUtils.isBlank(onlyMeituanShow)?"":onlyMeituanShow).append("）").toString();
        }
