        ...
        <div class="pure-menu pure-menu-open">
            ...
            <ul>
                ...
                <li ><a href="${ctx}/airchina/log">国航出票失败日志</a></li>
                 ...
                 <li class="menu-item-divided pure-menu-selected"><a href="${ctx}/log/bclog">各旗舰店订单行为</a></li>
...
<form action="${ctx}/log/bclog" method="post" class="pure-form">
...
<c:if test="${ flag == '2'}">
<font color=blue size=2>booking请求：</font>
${bl} <br>
<font color=blue size=2>生单请求：</font>
${cl} 
</c:if>

<c:if test="${ flag == '1' }">

<p><font color=blue size=5>暂未查询到订单${orderNo }相关行为！</font></p>
